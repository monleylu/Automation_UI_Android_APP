...
import com.testcase.product.tours.ToursUncommonUserName;
...
public class ToursUncommonUserNameTest {
	...
	logger.debug("开始参数化ToursUncommonUserNameTest");
	...
	logger.debug("开始setUpBeforeClass ToursUncommonUserNameTest");
    ...
    public ToursUncommonUserNameTest(TestUnit testUnit) {
	...
	if (isSingle) {
	    ...
	    logger.debug("清除tearDownAfterClass ToursUncommonUserNameTest 运行实例");
	}
    }
    ...
    @Test
    public void testCheckUncommonUserNameDialog() {
	...
	ToursUncommonUserName toursUncommonUserName = new ToursUncommonUserName();
	
	//25856221 欧阳喆喆用户
	SaveOrderResult saveOrderResult = toursUncommonUserName.checkUncommonUserNameDialog(toursProduct, testUnit, "25856221");
	//测试用例执行完毕，截图
