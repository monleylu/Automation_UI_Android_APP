...
public class UserLoginByCookies {
	...
	public static void setUpBeforeClass() throws Exception {
	    logger.debug("开始运行UserLoginByCookies");
	    if(driverFactory == null){
		    ...
		    //注入登录cookie默认存储路径和文件
		    testCookiesFileName = "UserLoginByCookies_Cookies.txt";
	...
	logger.debug("结束UserLoginByCookies");
	if (isSingle) {
	    ...
	    logger.debug("UserLoginByCookies:清除运行实例");
	}
    }
    ...
    @Test
    public void testUserLoginByCookies() {
	...
	// 通过域名参数退出
	// assertTrue("退出登录成功",
	// Logout.logoutSystem(androidDriver,"m.monlylu.com"));
