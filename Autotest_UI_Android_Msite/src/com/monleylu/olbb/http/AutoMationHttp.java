...
*/
package com.monleylu.olbb.http;
...
public class AutoMationHttp {
	...
	String urlString ="http://occamrazor.dev.monlylu.org/automation/getTestcaseWithRelateProduct?ID=";
	...
	String urlString ="http://occamrazor.dev.monlylu.org/automation/getAllTestCookies?ID=";
	return AutoMationHttp.getHttpResponseData(urlString + ID);
    }
