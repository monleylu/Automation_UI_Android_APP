...
public class PageProductStepOne extends BasePage implements CommonActionModule,GenericFlightModule{
	...
	public boolean clickNextPageElement() {
		...
		return this.clickNextStepBtn(By.id("com.monleylu.onlinebook:id/btn_submit"));
...
/*	    int loopCount=30;
	   ...
	   boolean b2=ElementUtil.isClickable(getDriver(), By.id("com.monleylu.onlinebook:id/btn_submit"), timeToWaitInSec);
	   return b1&&b2;
	}
	...
	public boolean isClickableOfNextPageElement() {
	    ...
	    return  ElementUtil.isClickable(this.getDriver(), By.id("com.monleylu.onlinebook:id/btn_submit"), 1);
	}
