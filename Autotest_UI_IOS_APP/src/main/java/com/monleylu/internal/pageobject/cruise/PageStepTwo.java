...
import com.monleylu.internal.pageobject.cruise.view.CruiseTourist;
...
public class PageStepTwo extends BasePage implements CommonActionModule {
    ...
    CruiseTourist cruiseTourist = new CruiseTourist(getDriver());
    ...
    /**
     *
     * 获取总共房间数目，目前没有处理火车票情况，待以后再处理
     * @return
     */
    public int getTotalCruiseRoomNum(){
        return  getDriver().findElementsByXPath("选择入住人").size();
    }
    ...
    public void agreeAllNotice() {
        ...
        List<IOSElement> listCheckBtn = getDriver().findElementsByXPath("//XCUIElementTypeButton[@name='onlinebook2 checkbox enabled u'  and @visible='true']");
    ...
    public CruiseTourist getCruiseTourist() {
        return cruiseTourist;
    }

    public void setCruiseTourist(CruiseTourist cruiseTourist) {
        this.cruiseTourist = cruiseTourist;
    }
